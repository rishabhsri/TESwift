...
@implementation UIImage (ResizeAndFitImage)
...
- (UIImage *)blurWithCoreImage:(UIImage *)sourceImage imageView:(UIImageView*)view radius:(id)inputRadius
{
    ...
    [gaussianBlurFilter setValue:inputRadius forKey:@"inputRadius"];
...
//    
//    CGSize size = topImage.size;
//    CGFloat aspect = size.width / size.height;
//    if (size.width / aspect <= size.height)
//    {
//        [topImage drawInRect:CGRectMake(0,0,size.width,size.width / aspect) blendMode:kCGBlendModeNormal alpha:0.8];
//    }
//    else
//    {
//        [topImage drawInRect:CGRectMake(0,0,size.height * aspect,size.height) blendMode:kCGBlendModeNormal alpha:0.8];
//    }
//
//    
...
//    CGImageRef maskRef = bottomImage.CGImage;
//    
...
//    
//    CGImageRef masked = CGImageCreateWithMask([topImage CGImage], mask);
//    return [UIImage imageWithCGImage:masked];
    
    
    CGImageRef imageReference = topImage.CGImage;
    CGImageRef maskReference = bottomImage.CGImage;
